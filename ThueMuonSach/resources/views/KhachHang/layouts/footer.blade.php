                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="footer__about">
                        <div class="footer__about__logo" style="line-height: 150px">
                            <a href="./index.html"><img src="img/logo1.png" alt="" width="50%" style="margin-left: 170px;"></a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 col-sm-6 offset-lg-1">
                    <div class="footer__widget">
                        ...
                        <ul style="list-style-type: none; color: #333; margin: 10px 0 0 0">
                            ...
                            <li><a style="color: #333" href="{{ route('route-khachhang-giohang') }}">Quản lý đơn hàng</a></li>
                        </ul>
                    </div>
                </div>
                    ...
                    <div class="footer__widget">
                        ...
                        <div class="footer__widget__social" style="margin: 10px 0 0 0">
                            <ul style="list-style-type: none; color: #333">
                                ...
                                <li>Email: VoVanNhi_WindWayShop</li>
                            </ul>
                        </div>
                    </div>
                </div>
