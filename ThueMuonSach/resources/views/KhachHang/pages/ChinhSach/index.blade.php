                ...
                <div class="col-lg-12">
                    <div class="">
                        ...
                        <p>• Chúng tôi lập ra trang website này để cung cấp dịch vụ thuê mượn sách, báo, và truyện.
                            ...
                            Quý khách nên thường xuyên kiểm tra các điều khoản và chính sách để nắm bắt những cập nhật mới
                            nhất
                            .</p>
                        <p>• Quý khách có quyền tạo tài khoản trên website để thuận tiện cho việc giao dịch, theo dõi lịch
                        ...
                        <p>• Quý khách không được phép sử dụng website cho bất kỳ mục đích nào ngoài việc thuê mượn ấn phẩm
                            sách,
                        ...
                        <p>• Việc thuê mượn ấn phẩm được thực hiện thông qua các bước lựa chọn, xác nhận đơn hàng, và thanh
                            toán trên website.
                            Đơn đặt hàng cũng có thể được khởi tạo qua điện thoại hoặc email, nhưng vẫn phải được ghi nhận
                            trên website. </p>
                        <h5>4.2 Xác nhận đơn hàng</h5>
                        <p>• Chúng tôi sẽ xác nhận đơn đặt hàng qua email và liên lạc với khách hàng để xác nhận chi tiết ấn
                            phẩm, số lượng,
                            địa điểm giao hàng, và các chi tiết khác. NumberTwo có quyền từ chối đơn hàng vì bất cứ lý do
                            nào và hoàn tiền
                            nếu người thuê đã thanh toán..</p>
                        <h5>4.3 Giá thuê</h5>
                        <p>• Giá thuê ấn phẩm đăng trên website chưa bao gồm chi phí vận chuyển,
                            nếu có. WindWayShop sẽ thông báo chi tiết về giá thuê và phí vận chuyển trước khi khách hàng
                            thanh toán.</p>
                        <h5>4.4 Vai trò và trách nhiệm</h5>
                        <p>• Bên cho thuê: Cung cấp đúng ấn phẩm đã xác nhận cho khách hàng và hỗ trợ các vấn đề liên quan đến
                            giao nhận,
                        ...
                        <p>• Khách hàng cần thông báo và tuân thủ quy trình đổi trả được nêu rõ trên website hoặc qua dịch vụ
                            khách hàng.</p>
                        <h4>6. Hóa đơn bán hàng</h4>
                        <p>• Chúng tôi cung cấp hóa đơn cho các đơn hàng và lưu trữ thông tin qua dịch vụ hóa đơn điện tử. Quý
                            khách cần cung
                            cấp thông tin đầy đủ để lập hóa đơn chính xác. </p>
                        <h4>7. Giao nhận hàng hóa/đổi trả</h4>
                        <p>• Việc giao nhận ấn phẩm sẽ phụ thuộc vào thỏa thuận giữa người thuê và bên cho thuê về việc sử
                            dụng dịch vụ giao nhận. <br>
                            • Trả đúng thời gian quy định và trả 1 lần, không trả từng cuốn
                        </p>
                        <h4>8. Quy định về thời gian mượn ấn phẩm quá hạn</h4>
                        <p> • Thời gian mượn tối đa cho mỗi ấn phẩm sẽ được quy định rõ ràng khi khách hàng thuê gồm: hạn
                            thuê là 15 ngày kể từ ngày nhận sách. <br>
                            • Nếu khách hàng không trả ấn phẩm đúng hạn, phí phạt sẽ được áp dụng cho mỗi ngày quá hạn gồm
                            5% giá trị sách. <br>
                            • Thông báo nhắc nhở sẽ được gửi cho khách hàng trước khi hết hạn mượn và thêm một lần sau khi
                            đã quá hạn. <br>
                        </p>
                        <h4>9. Quy định về thời gian thanh toán quá hạn</h4>
                        <p>• Thời hạn thanh toán: Khách hàng phải thanh toán toàn bộ các khoản phí phạt (nếu có) trong khi
                            trả sách. <br>
                            • Phí phạt thanh toán chậm: Nếu khách hàng không thanh toán đúng hạn (trả sách đúng hạn), sẽ áp
                            dụng phí phạt 5% trên tổng số tiền quá hạn cho mỗi ngày chậm trễ.
                        </p>
                        <h4>10. Quy định bồi thường khi ấn phẩm hư hỏng </h4>
                        <p>
                            • Đánh giá hư hỏng: Mức độ hư hỏng sẽ được đánh giá bởi nhân viên và xác định giá trị bồi thường
                            dựa trên mức độ thiệt hại (hư hỏng quá nhiều sẽ trừ vào tiền cọc). <br>
                            • Bồi thường: Khách hàng phải bồi thường 100% giá trị của ấn phẩm nếu không thể sửa chữa hoặc sử
                            dụng lại. Nếu có thể sửa chữa, mức phí sẽ do nhân viên quyết định.</p>
                        <h4>11. Quy định về mua sách từ khách hàng </h4>
                        <p>
                            • Yêu cầu: Khách hàng có thể bán sách của họ cho cửa hàng với điều kiện sách còn mới và không bị
                            hư hỏng. <br>
                            • Định giá: Giá mua lại sẽ được quyết định dựa trên tình trạng của sách và giá thị trường hiện
                            tại.
                        </p>
