                ...
                <div class="card shadow-sm">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-4">
                            ...
                            <p>Vui lòng chuyển khoản số tiền <strong>{{ number_format($grandTotal, 0, ',', '.') }}
                                    VND</strong> vào tài khoản trên và nhớ ghi rõ mã tham chiếu đơn hàng
                                <strong>{{ $paymentReference }}</strong> của bạn để chúng tôi có thể xác nhận thanh toán.
                            </p>
                        </div>
                        <!-- Nút Thanh Toán -->
