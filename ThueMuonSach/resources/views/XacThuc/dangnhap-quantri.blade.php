                        ...
                        <div class="row">
                            ...
                            <div class="col-md-7">
                                <div class="text-center text-black mb-4">
                                    <h4><i class="fas fa-user-lock"></i> Đăng nhập quản trị</h4>
                                </div>
                                <div class="card-body p-0">
                                    <form method="POST" action="{{ route('route-dangnhap-quantri') }}">
                                        @csrf
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="tentaikhoan" class="form-control"
                                                    id="tentaikhoan" placeholder="Nhập tên tài khoản" required>
                                            </div>
                                        </div>
