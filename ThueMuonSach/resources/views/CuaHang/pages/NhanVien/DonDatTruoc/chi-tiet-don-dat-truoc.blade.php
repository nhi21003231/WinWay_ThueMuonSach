      ...
      <div class="text-start col-4">
        ...
        <div class="pt-3">
          <div class="">
            ...
            <input type="text" class="form-control" value="{{ old('tenkhachhang',$hoaDonThue->khachhang->name) }}"
              name="tenkhachhang">
            @error('tenkhachhang')
          ...
          <div class="pt-4">
            ...
            <select name="loaidon" id="loaidon" class="form-select">
              ...
              <option value="Đơn đặt trước" {{ old('loaidon', $hoaDonThue->LoaiDon) == 'Đơn đặt trước' ? 'selected' : ''
                }}>Đơn đặt trước</option>
              <option value="Đơn Thuê" {{ old('loaidon', $hoaDonThue->LoaiDon) == 'Đơn Thuê' ? 'selected' : '' }}>Đơn
                Thuê</option>
            </select>
            @error('loaidon')
            <span class="text-danger fs-6 m-0 ps-1">{{ $message }}</span>
