                        ...
                        <tr>
                            ...
                            <td width="9%">
                                <img src="{{ asset('img/anh-an-pham/' . $anPham->chiTietAnPham->hinhanh) }}"
                                    class="img-fluid" width="100" height="100" alt="" data-bs-toggle="modal"
                            ...
                            <td width="9%">{{ number_format($anPham->giathue, 0, ',', '.') }} VNĐ</td>
                            <td width="9%">{{ number_format($anPham->giacoc, 0, ',', '.') }} VNĐ</td>
