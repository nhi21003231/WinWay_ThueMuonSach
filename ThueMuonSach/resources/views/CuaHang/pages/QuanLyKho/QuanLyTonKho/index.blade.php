...
@section('content')
    ...
    <div class="hstack gap-2 mb-4">
        ...
        <a href="{{ route('route-cuahang-quanlykho-quanlytonkho-capnhattinhtrang') }}" class="btn btn-secondary">
            Cập nhật tình trạng ấn phẩm
        </a>

        <a href="{{ route('route-cuahang-quanlykho-quanlytonkho-thanhlyanpham') }}" class="btn btn-secondary">
            Thanh lý ấn phẩm
        </a>
        ...
        <div class="dropdown">
            ...
            <ul class="dropdown-menu dropdown-menu-end">
                <li><a class="dropdown-item" href="{{ route('route-cuahang-quanlykho-quanlytonkho-nhapanphammoi') }}">Nhập
                        ấn phẩm mới</a></li>
                <li><a class="dropdown-item" href="{{ route('route-cuahang-quanlykho-quanlytonkho-nhapanphamdaco') }}">Nhập
                        ấn phẩm đã có</a></li>
            </ul>
        </div>
    </div>
        ...
        <table class="table text-center align-middle" id="ba-danhsach">
            <thead>
                <tr class="table-primary align-middle">
                    ...
                    <th scope="col" width="8%">Đã thuê</th>
                </tr>
            </thead>
