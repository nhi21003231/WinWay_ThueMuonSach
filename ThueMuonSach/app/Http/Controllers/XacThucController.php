...
class XacThucController extends Controller
{
    ...
    public function dangNhap(Request $request)
    {
        ...
        //         case 'nhanvien':
        //             return redirect()->route('route-cuahang-nhan-vien');
        //         case 'quanlycuahang':
        //             return redirect()->route('route-cuahang-quan-ly-cua-hang');
        //         case 'quanlykho':
        //             return redirect()->route('route-cuahang-quan-ly-kho');
        //         default:
    ...
    public function dangXuat(Request $request)
    {
        ...
        return redirect()->route('route-khachhang-trang-chu');
    }
}
